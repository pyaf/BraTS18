...
import argparse
from utils import (
    Brats2018TrainingN4ITKFilePaths,
    Brats2018ValidationN4ITKFilePaths,
    Brats2018TestingN4ITKFilePaths,
)
import os
import subprocess
...
def RegisterBrain(t1_path):
    ...
    subject2mni_mat = os.path.join(
        mni_path, t1_file[: t1_file.index("_t1_")] + "_MNI152_1mm_invol2refvol.mat"
    )
    mni2subject_mat = os.path.join(
        mni_path, t1_file[: t1_file.index("_t1_")] + "_MNI152_1mm_refvol2invol.mat"
    )
