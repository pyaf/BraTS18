...
t1_filepaths = [
    ...
    for root, dirs, files in os.walk(brats2018_path)
    for name in files
    if "t1" in name
    and "ce" not in name
    and "N4ITK" not in name
...
t1ce_filepaths = [
    ...
    for root, dirs, files in os.walk(brats2018_path)
    for name in files
    if "t1ce" in name and "N4ITK" not in name and name.endswith(".nii.gz")
]
t1ce_filepaths.sort()
...
t2_filepaths = [
    ...
    for root, dirs, files in os.walk(brats2018_path)
    for name in files
    if "t2" in name and "N4ITK" not in name and name.endswith(".nii.gz")
]
t2_filepaths.sort()
...
flair_filepaths = [
    ...
    for root, dirs, files in os.walk(brats2018_path)
    for name in files
    if "flair" in name and "N4ITK" not in name and name.endswith(".nii.gz")
]
