...
def get_scan_path(instance, filename):
    """each scan stored as <scan_id>.zip filename"""
    return "scans/%d/%s.zip" % (instance.patient.id, instance.scan_id)
...
class Patient(models.Model):
    ...
    picture = models.FileField(
        null=True, blank=True, upload_to=get_file_path, default="files/default.png"
    )
...
class Scan(models.Model):
    ...
    seg_file = models.FileField(null=True, blank=True)
